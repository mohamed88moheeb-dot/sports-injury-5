  ...
  return (
    <section className="dashboard-grid app-section app-section-light">
      ...
      <div className="metric-card accent-green">
        ...
        <strong>{next.phaseLabel || 'Not started'}</strong>
      </div>
      ...
      <div className="summary-card span-2 glass-card">
        <div className="summary-top">
          <div>
            <p className="eyebrow">Overall progress</p>
            <h3>{stats.completedDays} of {stats.totalDays} days completed</h3>
          </div>
      ...
      <div className="today-card span-2 glass-card">
      ...
      <div className="coach-note span-4 glass-card">
                                    ...
                                    {day.exercises.map((ex, eIndex) => {
                                      ...
                                      return (
                                        <div className="exercise-card" key={key}>
                                          <button className="exercise-main" onClick={() => setOpenExercise({ ...openExercise, [key]: !openExercise[key] })}>
